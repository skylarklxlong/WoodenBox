    ...
    public Drawable inflateDrawable(Context context, XmlPullParser parser, AttributeSet attrs) throws IOException, XmlPullParserException {
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (dr == null) {
                ...
                ColorFilter colorFilter = DrawableUtils.getAttrColorFilter(context, attrs, online.himakeit.skylark.R.attr.drawableTint, online.himakeit.skylark.R.attr.drawableTintMode);
                if (colorFilter != null) {
