    ...
    public Drawable inflateDrawable(Context context, XmlPullParser parser, AttributeSet attrs) throws IOException, XmlPullParserException {
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (drawable == null) {
                ...
                final ColorStateList cls = DrawableUtils.getTintColorList(context, attrs, online.himakeit.skylark.R.attr.drawableTint);
                if (cls != null) {
                    drawable = ThemeUtils.tintDrawable(drawable, cls, DrawableUtils.getTintMode(context, attrs, online.himakeit.skylark.R.attr.drawableTintMode));
                }
            }
