...
public class AppCompatCompoundDrawableHelper extends AppCompatBaseHelper<TextView> {
    ...
    void loadFromAttribute(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper, defStyleAttr, 0);
        mCompoundDrawableResIds[0] = a.getResourceId(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_android_drawableLeft, 0);
        mCompoundDrawableTintResIds[0] = a.getResourceId(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableLeftTint, 0);
        if (a.hasValue(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableLeftTintMode)) {
            mCompoundDrawableTintModes[0] = DrawableUtils.parseTintMode(a.getInt(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableLeftTintMode, 0), null);
        }
        mCompoundDrawableResIds[1] = a.getResourceId(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_android_drawableTop, 0);
        mCompoundDrawableTintResIds[1] = a.getResourceId(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableTopTint, 0);
        if (a.hasValue(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableTopTintMode)) {
            mCompoundDrawableTintModes[1] = DrawableUtils.parseTintMode(a.getInt(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableTopTintMode, 0), null);
        }
        mCompoundDrawableResIds[2] = a.getResourceId(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_android_drawableRight, 0);
        mCompoundDrawableTintResIds[2] = a.getResourceId(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableRightTint, 0);
        if (a.hasValue(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableRightTintMode)) {
            mCompoundDrawableTintModes[2] = DrawableUtils.parseTintMode(a.getInt(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableRightTintMode, 0), null);
        }
        mCompoundDrawableResIds[3] = a.getResourceId(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_android_drawableBottom, 0);
        mCompoundDrawableTintResIds[3] = a.getResourceId(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableBottomTint, 0);
        if (a.hasValue(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableBottomTintMode)) {
            mCompoundDrawableTintModes[3] = DrawableUtils.parseTintMode(a.getInt(online.himakeit.skylark.R.styleable.TintCompoundDrawableHelper_drawableBottomTintMode, 0), null);
        }
        a.recycle();
