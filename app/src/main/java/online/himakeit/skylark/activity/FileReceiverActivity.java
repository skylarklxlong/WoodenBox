...
import online.himakeit.skylark.util.FileReceiver;
...
public class FileReceiverActivity extends OtherBaseActivity {
    ...
    Handler mHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            if(msg.what == MSG_FILE_RECEIVER_INIT_SUCCESS){
                ...
                Toasts.showLong("收到一个任务：" + (fileInfo != null ? fileInfo.getFilePath() : ""));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogUtils.e("FileReceiverActivity onCreate");
        init();
    }
    @Override
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == REQUEST_CODE_WRITE_FILE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                // Permission Denied
                Toasts.showLong(R.string.tip_permission_denied_and_not_receive_file);
                onBackPressed();
            }
            return;
        }
    ...
    public void sendFileReceiverInitSuccessMsgToFileSender(IpPortInfo ipPortInfo) throws Exception{
        LogUtils.e(TAG, "sendFileReceiverInitSuccessMsgToFileSender------>>>start");
        ...
        LogUtils.e(TAG, "Send Msg To FileSender######>>>" + Constant.MSG_FILE_RECEIVER_INIT_SUCCESS);
        LogUtils.e(TAG, "sendFileReceiverInitSuccessMsgToFileSender------>>>end");
    }
