...
/**
 * Created by：LiXueLong 李雪龙 on 2017/7/25 14:41
 * <p>
...
public class FileReceiver extends BaseTransfer implements Runnable{
    ...
    public void run() {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.e(TAG, "FileReceiver init() --->>> occur expection");
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.e(TAG, "FileReceiver parseHeader() --->>> occur expection");
            if(mOnReceiveListener != null) mOnReceiveListener.onFailure(e, mFileInfo);
        }
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.e(TAG, "FileReceiver parseBody() --->>> occur expection");
            if(mOnReceiveListener != null) mOnReceiveListener.onFailure(e, mFileInfo);
        }
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.e(TAG, "FileReceiver finish() --->>> occur expection");
            if(mOnReceiveListener != null) mOnReceiveListener.onFailure(e, mFileInfo);
        }
    ...
    public void parseHeader() throws IOException {
        ...
        LogUtils.e(TAG, "FileReceiver receive header size------>>>" + headTotal);
        LogUtils.e(TAG, "FileReceiver receive header------>>>" + new String(headerBytes, UTF_8));
        ...
        LogUtils.e(TAG, "FileReceiver receive screenshot size------>>>" + screenshotTotal);
...
//        int fileSize = fileInfo.getSize();
        LogUtils.e(TAG, "parseHeader######>>>end");
    }
...
//            if(mOnReceiveListener != null) mOnReceiveListener.onProgress(total, fileSize);
        ...
        LogUtils.e(TAG, "FileReceiver body receive######>>>" + (TimesUtils.formatTime(endTime - startTime)));
        LogUtils.e(TAG, "FileReceiver body receive######>>>" + total);
    ...
    public void finish() {
        ...
        LogUtils.e(TAG, "FileReceiver close socket######>>>");
    }
