...
/**
 * Created by：LiXueLong 李雪龙 on 2017/10/19 18:22
 * <p>
...
public class MobCookCategoryEntity implements Serializable{
    ...
    private MobCategoryInfoBean categoryInfo;
    private List<MobCookCategoryEntity> childs;

    public MobCategoryInfoBean getCategoryInfo() {
        return categoryInfo;
    }

    public void setCategoryInfo(MobCategoryInfoBean categoryInfo) {
    ...
    public void setChilds(List<MobCookCategoryEntity> childs) {
        this.childs = childs;
    }

    public static class MobCategoryInfoBean implements Serializable{
