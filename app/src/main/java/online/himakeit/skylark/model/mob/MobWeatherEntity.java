...
/**
 * Created by：LiXueLong 李雪龙 on 2017/10/24 8:03
 * <p>
 * Mail : skylarklxlong@outlook.com
 * <p>
 * Description:
 */
public class MobWeatherEntity implements Serializable {
    ...
    private List<MobWeatherBean> result;
    ...
    public List<MobWeatherBean> getResult() {
        return result;
    }

    public void setResult(List<MobWeatherBean> result) {
        this.result = result;
    }

    public static class MobWeatherBean implements Serializable{
        ...
        private List<MobWeatherFutureBean> future;
        ...
        public List<MobWeatherFutureBean> getFuture() {
            return future;
        }

        public void setFuture(List<MobWeatherFutureBean> future) {
            this.future = future;
        }

        public static class MobWeatherFutureBean implements Serializable{
