 ...
 * Description:
 */
public class GankBaseFragment extends BaseFragment implements IGankFragment {
    ...
    public GankBaseFragment(String type) {
        super();
        mTtype = type;
    }

    public static GankBaseFragment newInstance(String type) {
        GankBaseFragment gankBaseFragment = new GankBaseFragment(type);
